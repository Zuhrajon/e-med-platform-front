...
export default function RegisterPage() {
    ...
    try {
      ...
      if (error instanceof ApiError) {
        if (error.status === 409) {
          ...
          setErrors({ general: 'Проверьте корректность введённых данных' })
        } else {
          setErrors({ general: 'Не удалось зарегистрироваться. Попробуйте снова.' })
        }
      } else {
        setErrors({ general: 'Не удалось зарегистрироваться. Попробуйте снова.' })
      }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f7f7f8] px-4 py-10">
      <div className="w-full max-w-4xl rounded-[32px] bg-white p-10 shadow-sm">
        <h1 className="text-4xl font-semibold text-slate-900">Регистрация</h1>
        <p className="mt-3 text-lg text-slate-500">Создайте новый аккаунт</p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div>
            <label className="mb-2 block">Пол</label>
            <select
              value={form.gender}
          ...
          <div>
            <label className="mb-2 block">Дата рождения</label>
            <input
              type="date"
          ...
          <div>
            <label className="mb-2 block">Адрес проживания</label>
            <input
              value={form.address}
          ...
          <div>
            <label className="mb-2 block">Номер документа</label>
            <input

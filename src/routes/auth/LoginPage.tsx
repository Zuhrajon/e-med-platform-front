                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className={`h-14 w-full rounded-2xl border bg-white px-5 text-lg text-slate-900 outline-none transition ${errors.email ? 'border-red-400 focus:border-red-500' : 'border-slate-200 focus:border-sky-500'
                                }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                            className={`h-14 w-full rounded-2xl border bg-white px-5 text-lg text-slate-900 outline-none transition ${errors.password ? 'border-red-400 focus:border-red-500' : 'border-slate-200 focus:border-sky-500'
                                }`}
                        />
